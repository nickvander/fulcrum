...
- **Entries** - Number of expense records
...
1. Click **+ Add Expense**
2. Select expense type (One-time or Recurring)
3. Fill in details:
   - **Description**: What the expense is for
   - **Amount**: Cost
   - **Category**: Select from defaults or create custom
   - **Date**: When the expense occurred
   - **Payment Method**: How you paid (optional)
   - **Reference #**: Invoice or receipt number (optional)
4. Click **Add Expense**
...
```
Net Profit = Revenue - COGS - Marketplace Fees - Expenses
```

Track expenses alongside sales data to understand your true business margins.
