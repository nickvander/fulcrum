...
> **Goal:** Polish the product list and details UI for mobile responsiveness,
> consistent branding, and improved data visibility.

## 1. Product Details Dialog

- [x] **Marketplace Deduplication**: Ensure only one badge per marketplace type
      (Amazon, eBay, etc.) is displayed.
- [x] **Barcode Cleanup**: Remove barcode from key stats as it's duplicated in
      "Labels & Codes".
- [x] **SKU Styling**: Make SKU smaller (`0.75rem monospace`) and less
      prominent.
- [x] **Create Bundle Button**: Standardize color to Material Pink (`#E91E63`)
      to match branding.
...
- [x] **Marketplace Deduplication**: Apply same deduplication logic to list/grid
      view badges.
...
- [x] **SCSS Fixes**: Resolve syntax errors (extra closing braces) and missing
      classes.
