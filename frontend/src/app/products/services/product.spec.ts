...
describe('ProductService', () => {
    ...
    beforeEach(() => {
        ...
        notificationServiceMock = TestBed.inject(NotificationService) as MockedObject<NotificationService>;
    });
    ...
    describe('createProduct', () => {
        it('should create a product, update the stream, and show notification', () => {
            const newProduct: Omit<Product, 'id'> = { name: 'New Product', sku: 'P003', description: '', default_resale_price: 30 } as any;
    ...
    describe('uploadImage', () => {
        it('should upload an image and return the file path', () => {
            ...
            const mockResponse = { file_path: 'uploads/test.jpg' } as any;
